...
public class APIConstants {
    ...
    public static final String $JIRA_REFERENCE_FIELDNAME = "jiraReference";
    public static final String $JIRA_DESCRIPTION_FIELDNAME = "jiraDescription";
    public static final String $AUTHOR_FIELDNAME = "author";
    public static String $GENERATOR_TYPE_FIELDNAME = "generation-type";

    public static String $GENERATOR_TYPE_BUILDER =  "builder";
    public static String $GENERATOR_TYPE_UTIL = "util";
    ...
    public static final String $ENTITY_BUILDER_CLASS_TEMPLATE = "resources/templates/BuilderClassModel.gtf";
    public static final String $ENTITY_BUILDER_WITH_METHOD_TEMPLATE = "resources/templates/WithModel.gtf";

    public static final String $ENTITY_UTIL_CLASS_TEMPLATE = "resources/templates/UtilClassModel.gtf";
    public static final String $ENTITY_UTIL_PROPERTY_TEMPLATE = "resources/templates/UtilPropertyModel.gtf";
    public static final String $ENTITY_UTIL_OBJECT_TEMPLATE = "resources/templates/UtilObjectModel.gtf";
