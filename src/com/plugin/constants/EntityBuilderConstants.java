...
public class EntityBuilderConstants {
    ...
    public static final String $NODE_TYPEKEY = "typekey";
    ...
    public static final String $ATTR_TYPELIST_NAME = "typelist";
    ...
    public static final String $ENTITY_ENDS_WITH_DLG = "_Dlg";
    ...
    public static final String $USES_TYPEKEY = "uses ";
